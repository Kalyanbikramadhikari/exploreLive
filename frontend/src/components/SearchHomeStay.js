...
import { useSearchHomeStayInCityQuery, useGetHomeStaysInCityQuery } from '../features/APISlices/homeStayAPI'
import { Link, useLocation } from 'react-router-dom';
import queryString from 'query-string';

const SearchHomeStay = () => {
    ...
    const cityData = useSearchHomeStayInCityQuery({city, min,asc, dasc, ddesc})

    const fetchcities = useGetHomeStaysInCityQuery({city,min,max,asc,dasc,ddesc})
